...
export default class PipScreenForTaskEditor extends ModuleScreen {
    ...
    constructor(props: ModuleScreenProps) {
        ...
        this.state = {
            ...
            VisionJob: "",
            ShootPose: [-87.700,-17.109,96.430,-0.000,100.679,-17.700],
            VisionPose: [1.946,-347.353,-0.289,0,0,-0.62],
            PickingPose: [9.658,-356.175,226.011,96.175,179.954,166.171]
    ...
    componentDidMount() {
        ...
        this.modulePackageManager = this.moduleContext.getSystemManager(
            Context.MODULE_PACKAGE_MANAGER,
        ) as IModulePackageManager;
        this.InitState();
    }
    ...
    componentDidUpdate(prevProps: Readonly<ModuleScreenProps>, prevState: Readonly<VisionData>, snapshot?: any): void {
        ...
        if (obj1.isConnected !== obj2.isConnected) {
            if (!obj2.readSignal.isError && obj2.isConnected) {
                ...
                this.communicationManager.tcpIp.tcpClientMessageReceived.unregister(
                    this.moduleContext,
                    this.readSingal,
                );
            }
        ...
        this.setState((prevState: VisionDataState) => ({
            visionData: {
                ...
                tcpState: {
                    ...prevState.visionData.tcpState,
                    ipAddress: {
                        ...prevState.visionData.tcpState.ipAddress,
                        [`${number}`]: value,
                    },
                },
            },
  ...
  updateVisionJob = (jobName: string) => {
        this.setState((prevState: VisionDataState) => ({
            visionData: {
                ...prevState.visionData,
        VisionJob: jobName,
            ...
            <ThemeProvider theme={this.systemTheme}>
                <div className={styles['pip-vision-container']}>
                        ...
                        <div className={styles['ip-address-port-wrap']}>
                            <div className={styles['ip-address-port-content']}>
                                <FormControl className={`${styles['ip-address-port-form']} ${styles['ip-address']}`}>
                                    ...
                                    <FormGroup row={true}>
                                        <TextField
                                            value={this.state.visionData.tcpState.ipAddress.input1}
                                        ...
                                        />
                                        <TextField
                                            value={this.state.visionData.tcpState.ipAddress.input2}
                                        ...
                                        />
                                        <TextField
                                            value={this.state.visionData.tcpState.ipAddress.input3}
                                        ...
                                        />
                                        <TextField
                                            value={this.state.visionData.tcpState.ipAddress.input4}
                                ...
                                <FormControl className={`${styles['ip-address-port-form']} ${styles['port']}`}>
                                    ...
                                    <FormGroup row={true}>
                                        <TextField
                                            value={this.state.visionData.tcpState.port}
                    ...
                    <VisionJob
                        ...
                        IVisionJob={this.state.visionData.VisionJob}
                        sendMessageTCP={this.sendCmdTcp}
                        receivedMsg={this.state.visionData.tcpState.readSignal.value}
                        updateVisionJob={this.updateVisionJob}
                        onUpdateDB={this.onBlur}
                    />
                    <ShootPose
                        moduleContext={this.moduleContext}
                        IshootPose={this.state.visionData.ShootPose}
                        onPoseChange={this.getShootPoseParam}
                        onUpdateDB={this.onBlur}
                    />
                    <VisionPose
                        moduleContext={this.moduleContext}
                        IvisionPose={this.state.visionData.VisionPose}
                        onPoseChange={this.getVisionPoseParam}
                        sendMessageTCP={this.sendCmdTcp}
                        receivedMsg={this.state.visionData.tcpState.readSignal.value}
                    />
                    <PickingPose
                        moduleContext={this.moduleContext}
                        IpickingPose={this.state.visionData.PickingPose}
                        onPoseChange={this.getPickingPoseParam}
                        onUpdateDB={this.onBlur}
                    />
                </div>
            </ThemeProvider>
